...
- Automatic SPA shell detection that retries with Playwright SPA-friendly waits for client-rendered pages
- New `autoDetectSpa` option to control SPA auto-detection behavior
