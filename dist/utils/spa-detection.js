 ...
 */
export function isLikelySpaShell(htmlContent) {
    if (!htmlContent)
        return true;
    const trimmed = htmlContent.trim();
    if (trimmed.length < 150 && /<noscript>/i.test(trimmed))
        return true;
    if (/<noscript>/i.test(htmlContent))
        return true;
...
//# sourceMappingURL=spa-detection.js.map