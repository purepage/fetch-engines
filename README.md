...
- `pnpm test:live:smoke` runs the browser-backed live smoke suite, including markdown fetch checks for `https://www.bhp.com/` and the Juno Pure Devotion product page.
